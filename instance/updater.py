...
from tools.core import bot
from tools.filters import command
from tools.decorators import bot_creator
from tools.database.dbqueue import get_active_chats, remove_active_chat
...
def updater():
    try:
        ...
        origin.fetch()
        repo.create_head("xmarty", origin.refs.xmarty)
        repo.heads.xmarty.set_tracking_branch(origin.refs.xmarty)
        repo.heads.xmarty.checkout(True)
    ac_br = repo.active_branch.name
