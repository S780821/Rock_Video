...
from tools.core import calls, bot
from pyrogram import Client, filters
from tools.design.thumbnail import thumb
from tools.design.chatname import CHAT_TITLE
from tools.queues import QUEUE, clear_queue
from tools.filters import command, other_filters
from tools.decorators import authorized_users_only
from tools.utils import skip_current_song, skip_item, remove_if_exists
from tools.database.dbpunish import is_gbanned_user

from tools.database.dbqueue import (
    is_music_playing,
    remove_active_chat,
    music_off,
    music_on,
)
from instance.utils.inline import (
    stream_markup,
    close_mark,
    back_mark,
)
